...
> **Nota:**
> Si desea utilizar otra base de datos diferente a postgresql, tendra que instalar la extension de la base de datos que
> corresponde con Quarkus. Por ejemplo:
>  ```bash 
